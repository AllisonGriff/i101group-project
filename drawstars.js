...
for(let i=0; i<totalStar; i++){
    ...
    >✦</span>`
        ...
        star=`<span class="star"
    style="animation: twinkle ${speed}s ${animationdelay}s infinite linear; width:${size}px; height:${size}px; top:${posTop}%;left:${posLeft}%; color:${color}; border-radius:${bdStarRD}%; box-shadow:${color} 0px 0px 30px 6px; display:flex; justify-content:center; align-items:center;">▴</span>`
    }
